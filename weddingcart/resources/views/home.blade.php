			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
						...
						<div class="feature-box fbox-center fbox-effect fbox-bg fbox-light fbox-border fbox-effect">
								...
								<div class="fbox-icon">
									<a href="{{ url('weddingdetails') }}"><i class="icon-line-paper"></i></a>
								</div>
								<h1>Wedding</h1>
...
eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad 
minim veniam, quis nostrud exercitation ullamco</p>
                                <a href="{{ url('/showproducts') }}" class="button button-border button-rounded button-xlarge topmargin">Creat</a>
							</div>			<!-- previous url is wishlist -->
						</div>
