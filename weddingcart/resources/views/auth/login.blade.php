...
<section class="sectionmar" id="content">
    ...
    <div id="login-wrap" class="content-wrap contdeg">
        ...
        <div class="container clearfix">
            ...
            <div class="accordion accordion-lg divcenter nobottommargin clearfix accordion-lgdiv">
                    ...
                    <form id="login-form" class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                            <div class="col-md-12">
                                ...
                                <input type="email" id="login-form-username" value="" class="form-control" name="email"
                                       value="{{ old('email') }}">
                                @if ($errors->has('email'))
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <div class="col-md-12">
                                ...
                                <input type="password" id="login-form-password" value="" class="form-control"
                                       name="password">
                        ...
                        <div class="center">
                            ...
                            <a href="{{ url('/social/auth/redirect', ['google']) }}"
                               class="button button-rounded si-google si-colored">Google</a>
                        </div>
                </div>
                </form>
                <div class="acctitle acctitlec">
                    <i class="acc-closed icon-user4"></i>
                    <i class="acc-open icon-ok-sign"></i>Don't have an Account? <a href="javascript::void(0)"
                ...
                <div class="acc_content clearfix div_con">
                    ...
                    <form class="form-horizontal" class="nobottommargin" role="form" method="POST"
                          action="{{ url('/register') }}">
                        {!! csrf_field() !!}
                        <label for="register-form-username">Name:</label>
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <div class="col-md-12">
                                <input type="text" id="register-form-username" class="form-control" name="name"
                                       value="{{ old('name') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <div class="col-md-12">
                                <input type="email" id="register-form-EmailAddress" class="form-control" name="email"
                                       value="{{ old('email') }}">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <div class="col-md-12">
                                <input type="password" id="register-form-confirmpassword" class="form-control"
